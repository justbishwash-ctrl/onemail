    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-sm animate-fade-in">
        ...
        <div className="flex items-center justify-center mb-8 gap-2">
          ...
          <span className="text-2xl font-semibold tracking-tight">Onemail</span>
        </div>
        ...
        <div className="bg-card border border-border rounded-2xl p-8 shadow-sm">
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-muted-foreground">
              Sign in to access your Gmail through a cleaner interface
            </p>
          </div>
          ...
          <p className="mt-4 text-xs text-muted-foreground text-center">
            You can connect multiple Google accounts after signing in
          </p>
        </div>

        <p className="mt-6 text-center text-xs text-muted-foreground">
          Onemail reads your Gmail through the official Gmail API.
          Your email stays in Google.
        </p>
      </div>
    </div>
  );
